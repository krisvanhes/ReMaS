<?php include 'includes/header.php'; ?>
    ...
    <form method="post" class="d-grid form-edit-component" style="">
        ...
        <div>
            ...
            <input id="deviceCompensation" type="number" step="0.01" name="deviceCompensation" placeholder="0.00">
        </div>

        <div>
            <label for="deviceWeight">Gewicht in grammen</label>
            <input id="deviceWeight" type="number" step="0.01" name="deviceWeight" placeholder="0.00">
        </div>
